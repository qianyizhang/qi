...
def register_collections(app: FastAPI):
    ...
    def game(collection_id: str, game_id: int):
    ...
    def position(collection_id: str, game_id: int, ply: int = Query(default=0, ge=0, le=300)):
    ...
    def evidence(collection_id: str, game_id: int, analysis_id: int):
