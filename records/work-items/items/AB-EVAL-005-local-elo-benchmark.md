...
### 2026-09-22 — evidence-route correction after package migration

Package extraction changed the supported import in the live benchmark-book
importer. The original bytes recorded by `benchmark-throughput-v1` remain at
commit `9c2162096d2763312d573ee5ef1291c2b54d2909` and are now retained under the
historical experiment directory. This appended revision points to that immutable
copy; it does not alter the earlier catalog block or its digest.
...
```experiment
{
  ...
  "evidence": [
    ...
    {
      "path": "data/experiments/benchmark-pilot-v1/import_benchmark_book.py",
      "role": "source",
      "sha256": "aa9641f97b2b757a570f8ed712bd8e52542983d80b0def1a092df1590b7b0440"
    }
  ],
  ...
  "evidence": [
    {
      "path": "records/reports/2026-09-14-saved-checkpoint-elo.md",
      "role": "report",
      "sha256": "93b911983c12f0fded0ca71303da428ff9b8578158bda93f8966437473cdd83f"
    },
    {
      "path": "data/evaluation/saved-checkpoint-elo-20260914.json",
      "role": "results",
